...
func main() {
	...
	telegram_bot_updates := top.Get_updates_from_telegram(uri_env_pathname, false)
	...
	top.Thumbs_down_feature(telegram_bot_updates, uri_env_pathname, config_pathname, false)
